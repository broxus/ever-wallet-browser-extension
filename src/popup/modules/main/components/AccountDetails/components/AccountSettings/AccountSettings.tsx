...
import { Button, Container, Content, SlidingPanelHandle, useResolve } from '@app/popup/modules/shared'
        ...
        <Container className="account-settings">
            <Content>
                ...
                <div className="account-settings__menu">
                    <Button design="ghost" className="account-settings__btn" onClick={handleRename}>
                        {intl.formatMessage({ id: 'RENAME' })}
                        <EditIcon />
                    </Button>
                    {onVerify && (
                        <Button design="ghost" className="account-settings__btn" onClick={handleVerify}>
                            {intl.formatMessage({ id: 'VERIFY_ON_LEDGER' })}
                            <CheckboxIcon />
                        </Button>
                    )}
                    <Button design="ghost" className="account-settings__btn" onClick={handleOpenInExplorer}>
                        {intl.formatMessage({ id: 'VIEW_IN_EXPLORER_BTN_TEXT' })}
                        <PlanetIcon />
                    </Button>
                    {onRemove && (
                        <Button design="alert" className="account-settings__btn" onClick={handleRemove}>
